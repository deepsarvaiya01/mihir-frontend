...
import { Bell, CheckCheck, FlaskConical, CheckCircle2, XCircle, Clock } from 'lucide-react'
  ...
  return (
    <>
      ...
      {open && createPortal(
        <div
          ref={dropdownRef}
          className="fixed z-[9999] w-80 overflow-hidden rounded-2xl border border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-black/10"
