    ...
    <div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
          {[
            { label: 'Total Partners',    value: totalLabs,             bg: 'bg-blue-50',    text: 'text-blue-600'    },
            { label: 'Active Partners',   value: activeLabs,            bg: 'bg-emerald-50', text: 'text-emerald-600' },
            { label: 'Inactive Partners', value: totalLabs - activeLabs, bg: 'bg-gray-50',    text: 'text-gray-500'    },
          ].map(s => (
